...
// add context for DrawContent - update the styling for bottom & right
...
const Drawer = ({
  ...
  // wrap draw in DrawContext.Provider and pass in the diirection props - consume in DrawContent
...
// consume direct prop from DrawContex
...
>(({ className, children, ...props }, ref) => {
  ...
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      {...props}
    >
      {/* Only show the notch if no direction or direction is bottom */}
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Title
    ref={ref}
    className={cn(
      "text-lg font-semibold leading-none tracking-tight mt-6",
      className
    )}
    {...props}
  />
